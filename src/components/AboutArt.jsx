 ...
 * scalable SVG.
 *
 * Same approach as the hero art: each layer keeps its exact Figma rotation,
 * but the group is expressed in a 365 x 378 viewBox instead of sitting on a
 * fixed 1440px stage. Coordinates are the Figma values offset by
 * (-794.37, -445), the top-left of the group's bounding box.
 */
