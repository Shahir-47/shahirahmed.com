 ...
 *
 * Same approach as the about art: every layer keeps its exact Figma rotation,
 * expressed in a 271 x 365 viewBox. Coordinates are the Figma values offset by
 * (-302, -408).
 *
 * The figure is squeezed horizontally to slim the torso and legs. The squeeze
 * wraps the whole body so the joins stay put, and the head is counter-scaled
 * back to full width inside it. The bars being climbed sit outside the squeeze.
 */
...
const BODY_CX = 100; // horizontal centre of the figure
const HEAD_CX = 113.47; // centre of the head layer
...
export default function ContactArt({ className }) {
	return (
		...
		>
			...
			{/* the three bars being climbed, left at full width */}
